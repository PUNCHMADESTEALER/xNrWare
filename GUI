...
function Library:Create(xHubName,xGameName)
    ...
    function xTabs:Tab(Name,xVisible)
        ...
        function Elements:Label(Name)
            ...
            LabelFrame.BackgroundColor3 = Color3.fromRGB(27, 42, 53)
        ...
        function Elements:Toggle(Name,Callback)
            ...
            ToggleButton.MouseButton1Down:Connect(function()
                ...
                if ToggleEnabled then 
                    game:GetService("TweenService"):Create(ToggleF, TweenInfo.new(0.3), {BackgroundColor3 = Color3.fromRGB(27, 42, 53)}):Play() 
        ...
        function Elements:Slider(Name,Min,Max,Callback)
            ...
            SliderTrail.BackgroundColor3 = Color3.fromRGB27, 42, 53
